...
export function createNodes(graph: DefaultGraph, games: Game[]): Map<number, INode> {
  ...
  for (const game of games) {
    ...
    <g transform='translate(17, -35) scale(0.5 0.5)'>
      ...
      <rect x = '-30' y='180' width='40' height='25' rx='3' fill=dark_color/>
      <rect x = '-12' y='180' width='4' height='70' fill=dark_color/>
      
      <text x='-10' y='197' font-size='15' text-anchor='middle' stroke='#000'  fill="#000" stroke-width='0.75px' stroke-linejoin='round' data-content='{Binding rank}'></text> 
