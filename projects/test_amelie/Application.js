import { Class, DefaultLabelStyle, EdgePathLabelModel, EdgeSides, GraphBuilder, GraphComponent, HierarchicLayout, HierarchicLayoutData, HierarchicLayoutNodeLayoutDescriptor, ICommand, LayoutExecutor, License, MinimumNodeSizeStage, PolylineEdgeStyle, ShapeNodeStyle, Size } from 'yfiles';
import { bindAction, bindCommand, reportDemoError, showApp } from '../resources/demo-app';
import { getLikedGraph } from './preprocessResources';
import { fetchLicense } from '../resources/fetch-license';
// @ts-ignore
let graphComponent = null;
let graphData = await getLikedGraph(false);
async function run() {
...
async function runLayout() {
    ...
    const hierarchicLayoutData = new HierarchicLayoutData({
        nodeLayoutDescriptors: (node) => new HierarchicLayoutNodeLayoutDescriptor({
